...
public:
    ...
    {
        return
            m_ros == usb_cam::constants::RGB8 || m_ros == usb_cam::constants::BGR8 ||
            m_ros == usb_cam::constants::RGBA8 || m_ros == usb_cam::constants::BGRA8 ||
            m_ros == usb_cam::constants::RGB16 || m_ros == usb_cam::constants::BGR16 ||
            m_ros == usb_cam::constants::RGBA16 || m_ros == usb_cam::constants::BGRA16 ||
            m_ros == usb_cam::constants::NV21 || m_ros == usb_cam::constants::NV24;
    }

    inline bool is_mono()
    {
        return m_ros == usb_cam::constants::MONO8 || m_ros == usb_cam::constants::MONO16;
    }

    inline bool is_bayer()
    {
        return 
            m_ros == usb_cam::constants::BAYER_RGGB8 || m_ros == usb_cam::constants::BAYER_BGGR8 ||
            m_ros == usb_cam::constants::BAYER_GBRG8 || m_ros == usb_cam::constants::BAYER_GRBG8 ||
            m_ros == usb_cam::constants::BAYER_RGGB16 || m_ros == usb_cam::constants::BAYER_BGGR16 ||
            m_ros == usb_cam::constants::BAYER_GBRG16 || m_ros == usb_cam::constants::BAYER_GRBG16;
    }
